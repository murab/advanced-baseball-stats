        ...
        <table id="hitters" class="table-bordered table-striped table-sm" style="font-size: 12px; line-height: 18px; margin: 0 auto;">
            ...
            @foreach($stats as $key => $stat)
                <tr>
                    ...
                    <td class="d-none d-md-table-cell" style="border-right: 1px solid black; @if ($stat['bats'] == 'L' && $stat['vsleft_wrc_plus'] >= 100) color: green; @endif @if ($stat['bats'] == 'L' && $stat['vsleft_wrc_plus'] >= 110) font-weight: bold; font-size: 1.2em; @endif">{{ $stat['vsleft_wrc_plus'] }}</td>
