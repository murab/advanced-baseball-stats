        ...
        <table id="hitters" class="table-bordered table-striped table-sm" style="font-size: 12px; line-height: 18px; margin: 0 auto;">
            ...
            @foreach($stats as $key => $stat)
                <tr>
                    ...
                    <td class="d-none d-lg-table-cell" style="border-right: 1px solid black;">{{number_format($stat['xhr_per_g'], 2)}}</td>
                    <td class="d-none d-md-table-cell">{{number_format($stat['xhr_per_g_rank'])}}</td>
